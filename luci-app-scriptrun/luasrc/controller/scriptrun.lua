...
local download_url = "https://github.com/3wlh/Actions-Source/releases/download/GitHub-Actions_sseconsole"
...
function action_index()
	if is_elf("/usr/sbin/" .. bin_file) then
...
function action_download()
	...
	local arch_map = { aarch64 = "arm64", x86_64 = "amd64" }
	local pkg_arch = arch_map[arch] or arch
	local bin_url  = download_url .. "/" .. bin_file .. "-" .. pkg_arch
	local bin_path = "/usr/sbin/" .. bin_file
