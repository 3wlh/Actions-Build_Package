...
Releases "${ARCH}" "${PACKAGES_PATH}" "api-static page-static sub-static luci-app-napcatapi netconfig"
...
"sunpanel luci-app-sunpanel luci-app-socat luci-i18n-socat-zh-cn"
